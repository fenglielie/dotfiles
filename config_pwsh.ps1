...
# pwsh module
$pwsh_module_target = "$pwsh_module_dir/mzcy_pwsh_utils"
if (Test-Path -Path $pwsh_module_target) {
    ...
    New-Item -ItemType SymbolicLink -Path $pwsh_module_target -Target "$script_root_dir/pwsh/mzcy_pwsh_utils" -Force
